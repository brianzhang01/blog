...
$$
The only other information we have relating these terms is that $R(w) \geq 0$ (for all $w$) and $0 \leq \lambda_1 < \lambda_2$. So we work with what we have. First,
$$
...
The other inequalities are trickier. Observe:
$$
...
Leveraging this fact, we additionally have
$$
l(w_1) + \lambda_1 R(w_1) \leq l(w_2) + \lambda_1 R(w_2)\\
